...
SCIEZKA = r"\lab_12\Skrypt render\roslinahero07ModelA.blend"
...
def importuj_rosline(sciezka_blend, nazwa_kolekcji):
    if not os.path.exists(sciezka_blend):
        print(f"BŁĄD: Plik źródłowy {sciezka_blend} nie istnieje!")
        return
    ...
    print(f"Zaimportowano kolekcję: {nazwa_kolekcji}")
